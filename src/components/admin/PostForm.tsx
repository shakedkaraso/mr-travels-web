...
export default function PostForm({
  ...
  return (
    <form action={action} className="max-w-2xl space-y-4">
      ...
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-brand-ink" htmlFor="cover_image_url">
          כתובת תמונה ראשית (לא חובה)
        </label>
        <input
          id="cover_image_url"
      ...
      <div>
        <label className="mb-1.5 block text-sm font-semibold text-brand-ink" htmlFor="excerpt">
          תקציר (לא חובה)
        </label>
        <textarea
          id="excerpt"
